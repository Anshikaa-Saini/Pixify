...
const Header = () => {
  return (
   ...
   <button className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-centergap-2 rounded-full'>
    Generate image 
    <img className='h-6' src={assets.star_group} alt="" />
   </button>

   <div className='flex flex-wrapjustify-center mt-16 gap-3'>
   ...
   <p className='mt-2 text-neutral-600'> Generated images from Pixify!</p>
    </div>
  )
}
